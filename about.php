...
<head>
    ...
    <style>
        .bgimg-1 {
            background-image: url('assets/img/nightcity.jpg');
        ...
        .navbar-custom .navbar-nav > li > a {
            color: #555 !important; /* Grey color for links */
        }
        ...
        .dropdown-menu > li > a {
            color: #555; /* Grey color for dropdown links */
        }
        ...
        .site-footer h5 {
            color: #fff; /* White text for footer headings */
        }
    </style>
</head>
