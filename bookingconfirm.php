...
// Define security deposit amount
$security_deposit = 150;

// Calculate the number of days
$total_days = ceil((strtotime($rent_end_date) - strtotime($rent_start_date)) / 86400) + 1;
$total_amount = $total_days * $price_day;

// Calculate the total amount including the security deposit
$total_amount_paid = $total_amount + $security_deposit;
...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="col-md-10" style="float: none; margin: 0 auto;">
            ...
            <br>
            <h4><strong>Security Deposit:</strong> CAD. <?php echo $security_deposit; ?></h4>
            <p><strong>Security deposit will be refunded after returning game if you return game on time or it will be deducted from the charge of number of days you borrowed the game.</strong></p>
            <br>
            <h4><strong>Total Amount Paid:</strong> CAD. <?php echo $total_amount_paid; ?></h4>
            <br>
        </div>
    </div>
