    ...
    <div class="container">
        ...
        <form action="editGame.php" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="game_name" name="game_name" value="<?php echo htmlspecialchars($game['game_name']); ?>" required>
            </div>
            <div class="form-group">
                <label for="trailer_link">Trailer Embed Link:</label>
                <input type="text" class="form-control" id="trailer_link" name="trailer_link" value="<?php echo htmlspecialchars($game['trailer_link']); ?>" required>
            </div>
            <div class="form-group">
                <label for="price_day">Price / Day:</label>
                <input type="text" class="form-control" id="price_day" name="price_day" value="<?php echo htmlspecialchars($game['price_day']); ?>" required>
            </div>
            <div class="form-group">
                <label for="game_availability">Game Availability (Yes/No):</label>
                <input type="text" class="form-control" id="game_availability" name="game_availability" value="<?php echo htmlspecialchars($game['game_availability']); ?>" required>
            </div>
            <div class="form-group">
                <label for="platform">Platform:</label>
                <input type="text" class="form-control" id="platform" name="platform" value="<?php echo htmlspecialchars($game['platform']); ?>" required>
            </div>
