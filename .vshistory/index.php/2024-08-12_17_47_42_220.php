...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
    ...
    <nav class="navbar navbar-custom navbar-fixed-top" role="navigation" style="color: white">
        <div class="container">
            ...
            <li><a href="enterGame.php" role="button" ><span class="glyphicon glyphicon-user"></span> Control Panel <span class="caret"></span> </a>
            </li>
          </ul>
                    </li>
                    <li>
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            <h1 class="brand-heading" style="color: white; font-family:Monsterrat, sans-serif; background:rgba(0,0,0, 0.5);"><b>GAMEVAULT</b></h1>
                            ...
                            <p class="intro-text" style="color: white;background:rgba(0,0,0);font-family: Consolas, sans-serif;">
                                A Game Rental Project By SQATE Section 3 Group 2
                            </p>
