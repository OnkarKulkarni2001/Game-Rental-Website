...
$sql1 = "UPDATE rentedgames SET game_return_date='$game_return_date', no_of_days='$duration', total_amount='$total_amount',fare = '$total_fine', return_status='$return_status' WHERE id = '$id' ";
