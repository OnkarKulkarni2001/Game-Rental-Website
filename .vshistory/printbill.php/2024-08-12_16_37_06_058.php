...
if ($extra_days > 0){
    $total_fine = $extra_days * $fare + 10; // Assuming fine is charged per extra day
}
...
<div class="container">
    <div class="jumbotron">
        ...
        <h4><strong>Fine: </strong> CAD. <?php echo ($total_fine . "/day");?></h4>
    </div>
</div>
<br>
...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="col-md-10" style="float: none; margin: 0 auto;">
            ...
            <br>
            <h3 style="color: red;"><strong>SECURITY DEPOSIT OF CAD. 150 WILL BE REFUNDED AFTER YOU RETURN GAME IN PERSON TO THE STORE!</strong></h4>
            <br>
        </div>
    </div>
