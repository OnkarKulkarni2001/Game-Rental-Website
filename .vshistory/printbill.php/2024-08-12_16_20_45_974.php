...
<div class="container">
    ...
    <div class="box">
        ...
        <div class="col-md-10" style="float: none; margin: 0 auto;">
            ...
            <br>
            <h3><strong $headingColor = "red"; // Change to desired color>SECURITY DEPOSIT OF CAD. 150 WILL BE REFUNDED AFTER YOU RETURN GAME IN PERSON TO THE STORE!</strong></h4>
            <br>
        </div>
    </div>
