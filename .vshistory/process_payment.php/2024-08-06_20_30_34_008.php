...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($payment_successful) {
        ...
        if ($conn->query($sql) === TRUE) {
            // Fetch game details for the confirmation page
            ...
            if ($result1 && $result1->num_rows > 0) {
                ...
                if ($result2 && $result2->num_rows > 0) {
                    ...
                    // Redirect to booking confirmation page with order details
                    header("Location: bookingconfirm.php?id=$orderId&game_name=$game_name");
                    exit();
                } else {
