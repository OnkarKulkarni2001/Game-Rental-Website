...
<div class="container" style="margin-top: 65px;">
    <div class="col-md-7" style="float: left; margin: 0 auto;">
      <div class="form-area">
        ...
        <div class="aligned">
            <img class="card-img-top" src="<?php echo $game_img; ?>" alt="Game image" width="200px" height="300px">
            <span>
                <h5><b><?php echo($game_name);?></b></h5>
                <img height="20" width="20" src="<?php echo $platform_img; ?>" alt="Platform image">
